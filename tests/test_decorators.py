...
def test_semantic_kernel_integration():
    ...
    try:
        ...
        assert hasattr(sk_decorated_func, "__kernel_function__"), "SK decorated function missing __kernel_function__ attribute"
        assert getattr(sk_decorated_func, "__kernel_function__") is True, "SK __kernel_function__ attribute should be True"
        
        # Ensure our decorated functions also have this attribute
        assert hasattr(our_decorated_func, "__kernel_function__"), "Our decorated function missing __kernel_function__ attribute"
        assert getattr(our_decorated_func, "__kernel_function__") is True, "Our __kernel_function__ attribute should be True"
        
        assert hasattr(our_direct_func, "__kernel_function__"), "Our direct decorated function missing __kernel_function__ attribute"
        assert getattr(our_direct_func, "__kernel_function__") is True, "Our direct __kernel_function__ attribute should be True"
